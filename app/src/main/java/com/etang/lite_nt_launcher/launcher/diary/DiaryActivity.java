package com.etang.lite_nt_launcher.launcher.diary;
...
import com.etang.lite_nt_launcher.tool.dialog.WriteDiaryDialog;
import com.etang.lite_nt_launcher.tool.sql.MyDiaryBaseHelper;
    ...
    private void check_sql() {
        try {
            ...
            if (cursor.getCount() != 0) {
                ...
                DiyToast.showToast(getApplicationContext(), "数据库为空，自动创建“Oasis来到了这个世界上”");
